...
I started my career as a Java developer in 2010, and it has been over 15 years working as a software developer.
Along the way, I have experienced some amazing things, and a lot of difficult things as well.
As I am not a super smart person by birth, I ended up learning many things the hard way.
...
6. You will not get tired if you are doing something that you love.
   ...
   Later you can go on and write boring REST APIs to earn money.
...
12. If you got accepted/rejected in an interview, don't take it entirely upon yourself.
    ...
    in their struggling company. So take it easy.
...
20. **If you realize that the work culture is bad, and you can't change anything there, then get out of there
...
21. We don't have an infinite amount of time to learn and master every programming language, framework, and tool.
    ...
    Follow Purpose-Driven Learning than just randomly tinkering around with everything that appeared on tech feeds.
...
23. **Learn how to ask for help**. If you are asking someone to help you then provide as many inputs as you can and specify the exact problem you are facing.
    Simply messaging "I want to build a highly scalable system. How?"
...
25. **Learn to say NO**. It is very difficult to say NO for unrealistic deadlines because many managers
    can't even conceive the idea of hearing NO from a subordinate. But over the time they understand when you say NO you mean NO.
    Even they start respecting you if you keep delivering on time when you say YES.

26. **Your past glory won't carry forward to your new company**. You have to prove yourself in the new organization
    before expecting them to realize your worth.

27. You need to ignore certain unpleasant things at work. Yes, a fellow developer who doesn't even know
    how to set JAVA_HOME might get an "Employee Of The Year" award; another person may get "Quality Champion"
    award for reasons that have little to do with code. There are certain things that are beyond your control and focusing on them only demotivates you at work. Learn to ignore those things, not easy...but need to learn.

28. If properly used, social media can help you to learn from experts, build network and
...
29. On weekends, it is perfectly ok to stay away from the computer, just chilling without doing anything as opposed to what
